...
public class DataStorage {
    ...
    public static final List<String> BRANCH_TYPES = List.of(
            "Вантажне відділення",      // ID: 1
            "Відділення",               // ID: 2 (Поштове)
            "Пункт приймання-видачі",   // ID: 3 (Пункт видачі)
            "Мобільне відділення",      // ID: 4
            "Міні-відділення",          // ID: 5
            "Сортувальний пункт"        // ID: 6
    );
